   ...
   <div class="feature" v-if="planetInfo">
      ...
      <div class="feature__info">
         ...
         <ul class="feature__list">
            ...
            <li class="feature-info__list">Population: {{planetInfo.population}}</li>
            <li class="feature-info__list">Rotation Period: {{planetInfo.rotation_period}}</li>
            <li class="feature-info__list">Оrbital period: {{planetInfo.orbital_period}}</li>
            ...
            <li class="feature-info__list">Surface water: {{planetInfo.surface_water}}</li>
         </ul>
      </div>
   </div>
</template>
...
export default {
   ...
   async created() {
      ...
      this.imagePlanet = await getImgService().getPlanetImgById(this.userID);
